// 农历换算（1900-01-31 ～ 2100-12-31），经典 lunarInfo 查表法
// 与 Python lunardate 包全量逐日对拍验证
(function (global) {
  const LUNAR_INFO = [
    ...
    0x0e968, 0x0d520, 0x0daa0, 0x16aa6, 0x056d0, 0x04ae0, 0x0a9d4, 0x0a2d0, 0x0d150, 0x0f242,
    0x0d520
  ];
  ...
  function lunarFromSolar(y, m, d) {
    if (y < 1900 || y > 2100) throw new Error("农历年份超出 1900-2100 范围");
  ...
  const api = { lunarFromSolar, leapMonth, monthDays, yearDays };
